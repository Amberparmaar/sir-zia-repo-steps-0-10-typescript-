...
export {};
//practice of arrays
// let array1 : string[] = ['mango', 'apple', 'banana', 'orange'];
// console.log(array1[2]); // banana
//Using Generic Array Type (Array<T>)
// let numbers: Array<number> = [1, 2, 3, 4, 5];
// numbers.push(6,7,8,9)
// console.log(numbers);
// let strings: Array<string> = ["apple", "banana", "cherry"];
// strings.unshift("pine apple");
// console.log(strings);
// let booleans: Array<boolean> = [true, false, true];
// console.log(booleans.length);
//.map()
//  let strings: Array<string> = ["apple", "banana", "cherry"];
//  let newArray = strings.map((strings) => strings.toUpperCase());
//  console.log(newArray);
// filtered
//  let numbers: Array<number> = [1, 2, 3, 4, 5, 6, 7, 8];
//  let newFilterd = numbers.filter((numbers) => numbers %2 !== 0); // odd numbr
//  console.log(newFilterd);
//find()
// let numbers: Array<number> = [1, 2, 3, 4, 5, 6, 7, 8];
// let newFind = numbers.find((numbers) => numbers > 4); // odd numbr
//  console.log(newFind);
//last indexof an array
// let numbers: Array<number> = [1, 2, 3, 4, 5, 6, 7, 8];
// let newArr = numbers.lastIndexOf(8);
// console.log(newArr);
// concate 
// let numbers: Array<number> = [1, 2, 3, 4, 5, 6, 7, 8];
// let number2 : Array<number> = [11, 12, 13, 14, 15, 16, 17, 18];
